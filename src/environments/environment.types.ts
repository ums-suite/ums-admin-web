...
export interface Environment {
  ...
  /**
   * `ums-core`'s base origin. Must match what `provideApi()` (the generated `@ums/shared` client's
   * `BASE_PATH`) AND `UMS_AUTH_CONFIG.baseUrl` are both configured with -- `AuthRefreshCoordinator`
   * calls `${baseUrl}/api/v1/identity/auth/refresh` directly, independent of the generated client,
